...
import { retrieveData } from "@/data/services/retrieve-data";
...
export async function updateProfileAction(userId, prevState, formData) {
  ...
  const responseData = await retrieveData(
    "PUT",
...
export async function uploadProfileImageAction(imageId, prevState, formData) {
