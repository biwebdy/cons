...
export default function SubClientForm({ client, isEdit, subclient = null }) {
  ...
  const [subclientInfo, setSubclientInfo] = useState({
    ...
    name: client?.name || "", // this is used in contract and must be defined, its the name of mother company for example nestle
